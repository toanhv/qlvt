...
if(_is_sqlserver()){
	/*
	$cmd = @mssql_init("USER_EndUserGetAllForGroup",$conn);
	...
	$arr_all_enduser_for_group = _get_row_to_array($result);
	@mssql_free_result($result);
	*/
	$v_sql_string = "Exec USER_EndUserGetAllForGroup ";
	$v_sql_string.= "".$v_application_id."";
	$v_sql_string.= ",".$v_item_id."";
	$arr_all_enduser_for_group = _adodb_query_data_in_number_mode($v_sql_string);	
}?>