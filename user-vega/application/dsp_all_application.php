...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td width="100%" class="normal_title"><?php echo CONST_APPLICATION_LIST_TITLE;?></td>
	</tr>
</table>
...
<table width="100%">
 	<tr>
	   	<td nowrap valign=top width="100%" colspan="10"><?php 
			...
			$v_current_id = -1;
			$show_object = 'false';
			$xml_str = built_xml_tree($arr_all_application,$v_current_id,'true','open.bmp','close.bmp','function.gif',$show_object);
			if (PHP_VERSION >= 5) {
				$xml = new DOMDocument;
				$xml->loadXML($xml_str);
