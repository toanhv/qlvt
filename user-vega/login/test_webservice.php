...
$v_app_code = 'ISA-LIST';
$v_staff_id = 1;
$v_modul_code = 'ISALIB_LISTTYPE';
$v_func_code = 'ISALIB_LISTTYPE_VIEW';
...
/*$v_app_code = 'ISA-KTXH';
$v_staff_id = 1858;
$v_modul_code = 'LIST_INDICATOR';
$v_func_code = 'LIST_INDICATOR_ADD';
$v_ip_address = _get_remote_ip_address();
$v_timeout = _CONST_ISA_USER_TIME_OUT;
$v_username = 'admin';
$v_password = 'admin';
*/
$v_current_staff_id_list = 1;

///////////////////////////////////////////////////////////////////////
echo "////////////////////////////////////////////////////////////////////////<br>";
echo "//              TESTING THE FUNCTIONS IN WEBSERVICE OF ISA-USER       //<br>";
echo "////////////////////////////////////////////////////////////////////////<br>";

//echo "set_permision_on_function($p_staff_id, $p_app_code, $p_modul_code, $p_function_code)<p>";
set_permision_on_function($v_staff_id, $v_app_code, $v_modul_code,$v_func_code);

echo "check_permision_on_modul($v_staff_id, $v_app_code, $v_func_code)<p>";
echo check_permision_on_function(@v_staff_id, $v_app_code,$v_func_code);

echo "is_app_enduser($v_staff_id,$v_app_code)<p>";
echo is_app_enduser(@v_staff_id,$v_app_code);

echo "get_all_modul_granted_for_user($v_app_code,$v_staff_id)<p>";
$str_return = get_all_modul_granted_for_user($v_app_code,$v_staff_id);
var_dump($str_return);

echo "get_all_public_modul($v_app_code)<p>";
echo get_all_public_modul($v_app_code);

echo "get_all_function_granted_for_user($v_app_code,$v_staff_id)<p>";
$str_return = get_all_function_granted_for_user($v_app_code,$v_staff_id);
var_dump($str_return);

echo "get_all_public_function($v_app_code)<p>";
echo get_all_public_function($v_app_code);

echo "is_logged($v_ip_address, $v_app_code,$v_timeout)<p>";
echo is_logged($v_ip_address, $v_app_code,$v_timeout);

echo "update_last_time($v_ip_address, $v_app_code,$v_staff_id)<p>";
echo update_last_time($v_ip_address, $v_app_code,$v_staff_id);


echo "get_personal_info_of_all_staff()<p>";
echo get_personal_info_of_all_staff();

echo "get_all_birthday_on_currendate()<p>";
echo get_all_birthday_on_currendate();

echo "get_personal_info_of_all_enduser($v_app_code)<p>";
echo get_personal_info_of_all_enduser($v_app_code);

echo "get_detail_info_of_all_unit()<p>";
echo get_detail_info_of_all_unit();

echo "get_all_group_of_application($v_app_code)<p>";
echo get_all_group_of_application($v_app_code);

echo "get_all_group_by_member($v_app_code,$v_staff_id)<p>";
$str_return =get_all_group_by_member($v_app_code,$v_staff_id);
var_dump($str_return);

echo "delete_enduser_logged($v_ip_address,$v_app_code,$v_staff_id)<p>";
echo delete_enduser_logged($v_ip_address,$v_app_code,$v_staff_id);

echo "get_all_position_group()<p>";
echo get_all_position_group();

echo "check_user_from_app($v_username,$v_password,$v_app_code)<p>";
echo check_user_from_app($v_username,$v_password,$v_app_code);

echo "is_logged_from_app($v_ip_address,18000)<p>";
$v_ret = is_logged_from_app('192.168.9.200',18000);
_write_log_file('xml.txt',$v_ret);

echo "get_new_enduser_of_single_app($v_app_code, $v_current_staff_id_list)<p>";
$ret_value = get_new_enduser_of_single_app($v_app_code, $v_current_staff_id_list);
var_dump($ret_value);
...
function set_permision_on_function($p_staff_id, $p_app_code, $p_modul_code, $p_function_code){
	...
	*/
	$v_sql_string = "Exec USER_SetPermisionOnFunction ";
	$v_sql_string.= "".$p_staff_id."";
	$v_sql_string.= ",'".$p_app_code."'";
	$v_sql_string.= ",'".$p_modul_code."'";
	$v_sql_string.= ",'".$p_function_code."'";
	$arr = _adodb_exec_update_delete_sql($v_sql_string);
	return 'true';
}
...
function check_permision_on_modul($p_staff_id, $p_app_code, $p_modul_code){
	...
	*/
	$v_sql_string = "Exec USER_CheckPermissionOnModul ";
	$v_sql_string.= "".$p_staff_id."";
	$v_sql_string.= ",'".$p_app_code."'";
	$v_sql_string.= ",'".$p_modul_code."'";
	$arr = _adodb_exec_update_delete_sql($v_sql_string);
...
function check_permision_on_function($p_staff_id, $p_app_code, $p_function_code){
	...
	$arr = @mssql_fetch_array($result);
	*/
	$v_sql_string = "Exec USER_CheckPermissionOnFunction ";
	$v_sql_string.= "".$p_staff_id."";
	$v_sql_string.= ",'".$p_app_code."'";
	$v_sql_string.= ",'".$p_function_code."'";
	$arr = _adodb_exec_update_delete_sql($v_sql_string);
...
function is_app_enduser($p_staff_id,$p_app_code){
	...
	*/
	$v_sql_string = "Exec USER_EndUserCheckBelongToApp ";
	$v_sql_string.= "".$p_staff_id."";
	$v_sql_string.= ",'".$p_app_code."'";
	$arr = _adodb_exec_update_delete_sql($v_sql_string);
	$v_count = sizeof($arr);
...
function get_all_modul_granted_for_user($p_app_code,$p_staff_id){
	...
	*/
	$list_id = '';
	$v_sql_string = "Exec USER_GetAllModulGrantedForUser ";
	$v_sql_string.= "'".$p_app_code."'";
	$v_sql_string.= ",".$p_staff_id."";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	if ($v_count>0) {
		for ($i=0; $i<$v_count; $i++){
			$rs = $arr[$i];
			//$arr=@mssql_fetch_array($result);
			$list_id = $list_id . htmlspecialchars($rs['C_CODE']);
			if ($i<$v_count){
				$list_id = $list_id . ',';
			}
		}
...
function get_all_public_modul($p_app_code){
	...
	*/
	$list_id = '';
	$v_sql_string = "Exec User_GetAllPublicModul ";
	$v_sql_string.= "'".$p_app_code."'";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	if ($v_count>0) {
...
function get_all_function_granted_for_user($p_app_code,$p_staff_id){
	...
	*/
	$list_id = '';
	$v_sql_string = "Exec User_GetAllFunctionGrantedForUser ";
	$v_sql_string.= "'".$p_app_code."'";
	$v_sql_string.= ",".$p_staff_id."";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
...
function get_all_public_function($p_app_code){
	...
	*/
	$list_id = '';
	$v_sql_string = "Exec User_GetAllPublicFunction ";
	$v_sql_string.= "'".$p_app_code."'";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	if ($v_count>0) {
...
function is_logged($p_ip_address, $p_app_code,$p_timeout){
	...
	$arr=@mssql_fetch_array($result);
	*/
	$v_sql_string = "Exec USER_IsLogged ";
	$v_sql_string.= "'".$p_ip_address."'";
	$v_sql_string.= ",'".$p_app_code."'";
	$v_sql_string.= ",".$p_timeout."";
	$arr = _adodb_exec_update_delete_sql($v_sql_string);
	if (sizeof($arr)>0){
...
function is_logged_from_app($p_ip_address, $p_timeout){
	...
	$v_count = @mssql_num_rows($result);
	*/
	$v_sql_string = "Exec USER_IsLoggedFromApp ";
	$v_sql_string.= "'".$p_ip_address."'";
	$v_sql_string.= ",".$p_timeout."";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	...
	if ($v_count>0){
		//while ($i$rs = @mssql_fetch_array($result)) {
		for ($i=0;$i<$v_count;$i++){
			$rs = $arr[$i];
...
function get_personal_info_of_all_staff(){
	...
	$result = mssql_execute($cmd);
	*/
	$v_sql_string = "Exec USER_GetPersonalInfoOfAllStaff ";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
...
function get_personal_info_of_all_enduser($p_app_code){
	...
	$result = mssql_execute($cmd);
	*/
	$v_sql_string = "Exec USER_GetPersonalInfoOfAllEndUser ";
	$v_sql_string.= "'".$p_app_code."'";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	$strXML='<?xml version="1.0" encoding="UTF-8"?>' . "\n";
...
function get_detail_info_of_all_unit(){
	...
	$result = mssql_execute($cmd);
	*/
	$v_sql_string = "Exec USER_GetDetailInfoOfAllUnit ";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	$strXML='<?xml version="1.0" encoding="UTF-8"?>' . "\n";
	$strXML.="<unit_list>" . "\n";
...
function get_all_group_of_application($p_app_code){
	...
	$result = mssql_execute($cmd);
	*/
	$v_sql_string = "Exec USER_GetAllGroupOfApplication ";
	$v_sql_string.= "'".$p_app_code."'";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	$strXML='<?xml version="1.0" encoding="UTF-8"?>' . "\n";
...
function get_all_group_by_member($p_app_code,$p_staff_id){
	...
	$v_count = @mssql_num_rows($result);
	*/
	$v_sql_string = "Exec USER_GroupGetAllByMember ";
	$v_sql_string.= "'".$p_app_code."'";
	$v_sql_string.= ",".$p_staff_id."";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
...
function check_user_from_app($p_username,$p_password,$p_app_code){
	...
	$result = mssql_execute($cmd);
	*/
	$v_sql_string = "Exec USER_CheckUserFromApp ";
	$v_sql_string.= "'".$p_username."'";
	$v_sql_string.= ",'".$p_password."'";
	$v_sql_string.= ",'".$p_app_code."'";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	$strXML='<?xml version="1.0" encoding="UTF-8"?>' . "\n";
...
function get_new_enduser_of_single_app($p_app_code, $p_current_staff_id_list){
	...
	$result = mssql_execute($cmd);
	*/
	$v_sql_string = "Exec USER_GetNewEndUserOfSingleApp ";
	$v_sql_string.= "'".$p_app_code."'";
	$v_sql_string.= ",'".$p_current_staff_id_list."'";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	$strXML='<?xml version="1.0" encoding="UTF-8"?>' . "\n";
	$strXML.="<user_list>" . "\n";
...
function get_all_birthday_on_currendate(){
	...
	$v_count = @mssql_num_rows($result);
	*/
	$v_sql_string = "Exec USER_GetAllPersonalHaveBirthdayOnCurrenday ";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	$strXML='<?xml version="1.0" encoding="UTF-8"?>';
...
function get_all_application_on_isa_user(){
	...
	$v_count = @mssql_num_rows($result);
	*/
	$v_sql_string = "Exec User_GetAllApplication ";
	$arr = _adodb_query_data_in_name_mode($v_sql_string);
	$v_count = sizeof($arr);
	$strXML='<?xml version="1.0" encoding="UTF-8"?>' . "\n";
