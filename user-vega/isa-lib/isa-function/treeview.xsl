		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr id="str_obj">
				...
				<!--Neu cho hien cac nut-->
					...
					<td valign="top" align="left" colspan="3">
					<a onclick="node_image_onclick(this,'{$show_control}','{$opening_node_img_name}','{$closing_node_img_name}',document.all.hdn_list_parent_id)" class="folder" >
					...
					<a onclick="node_name_onclick(this,'{$select_parent}')">
						<xsl:attribute name="id">
							<xsl:value-of select="@id"/>
						</xsl:attribute>
