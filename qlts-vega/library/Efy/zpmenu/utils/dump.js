 ...
 * $Id: dump.js 508 2005-06-17 23:31:03Z dror $
 * 
 * Heavily borrowed from htmlarea. 
 */

dump = function (domElement) {
  ...
  outputWindow.document.write(dump.getHTML(domElement));
...
dump.getHTML = function(root, outputRoot, levelSpacing) {
	if(!levelSpacing) {
		levelSpacing = "";
	}
	...
	switch (root.nodeType) {
		...
		case 11: // Node.DOCUMENT_FRAGMENT_NODE
				...
				for (i = 0; i < attrs.length; ++i) {
					...
					if (name != "style") {
						...
						if (typeof root[a.nodeName] != "undefined" && name != "href" && name != "src") {
							...
							if (dump.is_ie && (name == "href" || name == "src")) {
								value = stripBaseURL(value);
							}
						}
			...
			for (i = root.firstChild; i; i = i.nextSibling) {
				html += levelSpacing + this.getHTML(i, true, levelSpacing + "  ");
			}
		...
		case 3: // Node.TEXT_NODE
			...
			else html = this.htmlEncode(root.data);
			break;
